error id: file:///C:/Users/barra/Desktop/Ryan/Perso/JavaProjects/BudgetApp/BudgetApp.java:_empty_/getTableView#
file:///C:/Users/barra/Desktop/Ryan/Perso/JavaProjects/BudgetApp/BudgetApp.java
empty definition using pc, found symbol in pc: _empty_/getTableView#
...
public class BudgetApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Gestionnaire de Budget - v4");
    ...
    private VBox createHeader() {
        ...
        btnNouveauMois.setTooltip(new Tooltip("Nouveau Mois (Nettoyage)"));
    ...
    private VBox createCenter() {
        ...
        // 2. Colonne NOM (Avec MARGE à gauche)
        ...
        colNom.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    setText(item);
                    setPadding(new Insets(0, 0, 0, 20)); // AJOUT : Marge de 20px devant le nom
                    setAlignment(Pos.CENTER_LEFT);
                }
            }
        });

        // 3. Colonne MONTANT (CENTRÉ)
        ...
        colMontant.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(Double item, boolean empty) {
                ...
                if (empty || item == null) setText(null);
                    ...
                    setAlignment(Pos.CENTER); // MODIFICATION : Prix au centre
        ...
        // 5. Colonne MODIFIER (Icône seule)
        ...
        // 6. Colonne SUPPRIMER (Icône seule)
    ...
    private void modifierPrix(Depense d) {
        ...
        dialog.setHeaderText("Désignation : " + d.getNom());
    ...
    private VBox createBottom() {
        ...
        tfNom.setPromptText("Désignation (Loyer, EDF, Courses...)");
        HBox.setHgrow(tfNom, Priority.ALWAYS);

        TextField tfMontant = new TextField(); 
        tfMontant.setPromptText("Prix €");
    ...
    private String getStylesheet() {
        return "data:text/css," +
                ...
                ".card-label { -fx-font-size: 11; -fx-text-fill: #64748b; -fx-font-weight: bold; -fx-text-transform: uppercase; }" +
                ".budget-field { -fx-font-size: 18; -fx-font-weight: bold; -fx-background-color: #f8fafc; -fx-border-color: #e2e8f0; -fx-border-radius: 6; }" +
                ...
                ".btn-primary-icon { -fx-background-color: #4f46e5; -fx-text-fill: white; -fx-font-size: 20px; -fx-cursor: hand; -fx-background-radius: 50; -fx-min-width: 42; -fx-min-height: 42; }" +
                ".btn-header-icon { -fx-background-color: rgba(255,255,255,0.2); -fx-text-fill: white; -fx-font-size: 20px; -fx-cursor: hand; -fx-background-radius: 8; -fx-border-color: white; }" +
                ".btn-action-delete { -fx-background-color: #fee2e2; -fx-text-fill: #ef4444; -fx-font-size: 16px; -fx-cursor: hand; -fx-background-radius: 6; }" +
                ".btn-action-edit { -fx-background-color: #e0f2fe; -fx-text-fill: #0ea5e9; -fx-font-size: 16px; -fx-cursor: hand; -fx-background-radius: 6; }";
    }

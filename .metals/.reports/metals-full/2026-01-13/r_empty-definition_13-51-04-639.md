error id: file:///C:/Users/barra/Desktop/Ryan/Perso/JavaProjects/BudgetApp/BudgetApp.java:_empty_/getTableView#getItems#
file:///C:/Users/barra/Desktop/Ryan/Perso/JavaProjects/BudgetApp/BudgetApp.java
empty definition using pc, found symbol in pc: _empty_/getTableView#getItems#
...
public class BudgetApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Gestionnaire de Budget - Visibilité Optimisée");
    ...
    private VBox createHeader() {
        ...
        Button btnNouveauMois = new Button("🗓️Nouveau Mois");
        btnNouveauMois.getStyleClass().add("btn-secondary");
    ...
    private VBox createBudgetCard(String label, DoubleProperty property) {
        ...
        card.setPrefWidth(210); // Augmenté
        card.setPrefHeight(90); // Augmenté
    ...
    private VBox createCenter() {
        ...
        TableColumn<Depense, String> colNom = new TableColumn<>("Nom de la dépense");
        ...
        colRecurrente.setPrefWidth(100);
        ...
        colActions.setCellFactory(col -> new TableCell<>() {
            private final Button btnSuppr = new Button("🗑️Supprimer");
            {
                btnSuppr.getStyleClass().add("btn-delete-text");
        ...
        TableColumn<Depense, Void> colEdit = new TableColumn<>("Modifier");
        colEdit.setPrefWidth(100);
        colEdit.setCellFactory(col -> new TableCell<>() {
            private final Button btnEdit = new Button("✏️Prix");
            {
                btnEdit.getStyleClass().add("btn-edit-text");
                btnEdit.setOnAction(e -> {
                    Depense d = getTableView().getIte@@ms().get(getIndex());
                    modifierPrix(d);
                });
            }
            @Override
        ...
        tableView.getColumns().addAll(colCochee, colNom, colMontant, colRecurrente, colActions, colEdit);
    ...
    private void modifierPrix(Depense d) {
        ...
        dialog.setHeaderText("Mettre à jour le prix de : " + d.getNom());
        dialog.setContentText("Nouveau montant (€) :");
    ...
    private VBox createBottom() {
        ...
        Label title = new Label("➕ Ajouter une dépense");
        ...
        tfNom.setPromptText("Ex: Loyer, EDF, Courses...");
        ...
        bottom.getChildren().addAll(title, form);
        return bottom;
    }
    ...
    private String getStylesheet() {
        return "data:text/css," +
                ...
                ".btn-primary { -fx-background-color: #4f46e5; -fx-text-fill: white; -fx-cursor: hand; -fx-font-weight: bold; -fx-padding: 10 20; }" +
                ".btn-secondary { -fx-background-color: rgba(255,255,255,0.2); -fx-text-fill: white; -fx-font-weight: bold; -fx-cursor: hand; -fx-border-color: white; -fx-border-radius: 6; }" +
                ".btn-delete-text { -fx-background-color: #fee2e2; -fx-text-fill: #ef4444; -fx-font-size: 11; -fx-font-weight: bold; -fx-cursor: hand; }" +
                ".btn-edit-text { -fx-background-color: #e0f2fe; -fx-text-fill: #0ea5e9; -fx-font-size: 11; -fx-font-weight: bold; -fx-cursor: hand; }";
    }

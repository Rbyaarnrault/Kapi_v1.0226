error id: file:///C:/Users/barra/Desktop/Ryan/Perso/JavaProjects/BudgetApp/BudgetApp.java:_empty_/getIndex#
file:///C:/Users/barra/Desktop/Ryan/Perso/JavaProjects/BudgetApp/BudgetApp.java
empty definition using pc, found symbol in pc: _empty_/getIndex#
        ...
        colEdit.setCellFactory(col -> new TableCell<>() {
            private final Button btnEdit = new Button("✏️Prix");
            {
                ...
                btnEdit.setOnAction(e -> {
                    Depense d = getTableView().getItems().get(getI@@ndex());
                    modifierPrix(d);
                });
            }
            @Override

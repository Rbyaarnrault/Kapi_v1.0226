error id: file:///C:/Users/barra/Desktop/Ryan/Perso/JavaProjects/BudgetApp/BudgetApp.java:_empty_/TextField#
...
public class BudgetApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        double targetHeight = screenBounds.getHeight() * 0.85;
    ...
    private VBox createCenter() {
        ...
        colActions.setCellFactory(col -> new TableCell<>() {
            private final Button btnSuppr = new Button("🗑️ Supprimer");
            {
        ...
        colEdit.setCellFactory(col -> new TableCell<>() {
            private final Button btnEdit = new Button("✏️ Prix");
            {
    ...
    private VBox createBottom() {
        ...
        TextField tfMontant = new TextFiel@@d(); 
